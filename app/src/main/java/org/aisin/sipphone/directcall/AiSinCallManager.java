 ...
 *
 */
public class AiSinCallManager {

	private static AiSinCallManager instance;
	
	private AiSinCallManager() {}
	public static final synchronized AiSinCallManager getInstance() {
		if (instance == null) instance = new AiSinCallManager();
		return instance;
	}
